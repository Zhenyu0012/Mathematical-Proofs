...
1. Proving $A$ onto $B$ or $B$ onto $A$ is trivial since we know $\forall b\in B, \exists a\in A$, s.t., $a\mapsto b$, or vice versa. Not clearly writing this correspondence out is allowable because it will be verified after defining a linear relation between $A$ and $B$.
