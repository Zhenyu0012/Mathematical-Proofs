...
1. Since we know two sets have infinite elements, proving $A$ onto $B$ or $B$ onto $A$ is trivial. Not clearly writing this correspondence out is allowable because it will be verified after defining a linear relationship between $A$ and $B$.
