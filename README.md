...
1. Since we know two sets have infinite elements, proving $A$ onto $B$ or $B$ onto $A$ is trivial. Omitting this correspondence is allowable because it will be verified after defining a linear relationship between $A$ and $B$.
